 ...
 * It is intended to use from the Tests Runner Plug-in.
 * 
...
public interface ITestModelUpdater {
	...
	/**
	 * Specifies that the most top test suite has been finished.
	 ...
	 * The test execution time is set is Tests Runner Plug-in requires time 
	 * measurement.
	 */
