...
public class BoostXmlLogHandler extends DefaultHandler {
	...
	private void logAndThrowError(String message) throws SAXException {
		BoostTestsRunnerPlugin.logErrorMessage(message);
		throw new SAXException(message);
	}

	
	public void warning(SAXParseException ex) throws SAXException {
		BoostTestsRunnerPlugin.logErrorMessage("XML warning: "+ex.getMessage()); //$NON-NLS-1$
	}

	public void error(SAXParseException ex) throws SAXException {
		BoostTestsRunnerPlugin.logErrorMessage("XML error: "+ex.getMessage()); //$NON-NLS-1$
		throw ex;
	}

	public void fatalError(SAXParseException ex) throws SAXException {
		BoostTestsRunnerPlugin.logErrorMessage("XML fatal error: "+ex.getMessage()); //$NON-NLS-1$
		throw ex;
	}
